...
<body>
  ...
  <script>
    ...
    // 🎯 Função para marcar chat como finalizado
    function markChatCompleted() {
      ...
      completedDiv.innerHTML = `
        <strong>✅ Atendimento Finalizado</strong><br>
        <small>Nossa equipe entrará em contato em breve!</small>
      `;
      ...
      console.log('🎉 Chat marcado como finalizado');
    }
    ...
    async function sendMessage() {
      ...
      // Verificar se chat está finalizado
      if (chatState.isCompleted) {
        console.log('⚠️ Chat finalizado - use Nova Conversa');
        return;
      }
